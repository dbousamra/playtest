...
def list(p:Int = 0, s:Int = 2, f:String = "") = {
   Call("GET", "/models" + queryString(List(if(p == 0) None else Some(implicitly[QueryStringBindable[Int]].unbind("p", p)), if(s == 2) None else Some(implicitly[QueryStringBindable[Int]].unbind("s", s)), if(f == "") None else Some(implicitly[QueryStringBindable[String]].unbind("f", f)))))
}
                                                        
 
// @LINE:20
def delete(id:Long) = {
   Call("POST", "/models/" + implicitly[PathBindable[Long]].unbind("id", id) + "/delete")
}
...
// @LINE:17
def update(id:Long) = {
   Call("POST", "/models/" + implicitly[PathBindable[Long]].unbind("id", id))
}
...
// @LINE:16
def edit(id:Long) = {
   Call("GET", "/models/" + implicitly[PathBindable[Long]].unbind("id", id))
}
...
def delete = JavascriptReverseRoute(
   ...
   """
      function(id) {
      return _wA({method:"POST", url:"/models/" + (""" + implicitly[PathBindable[Long]].javascriptUnbind + """)("id", id) + "/delete"})
      }
   """
)
...
def create = JavascriptReverseRoute(
   ...
   """
      function() {
      return _wA({method:"GET", url:"/models/new"})
      }
   """
)
...
def update = JavascriptReverseRoute(
   ...
   """
      function(id) {
      return _wA({method:"POST", url:"/models/" + (""" + implicitly[PathBindable[Long]].javascriptUnbind + """)("id", id)})
      }
   """
)
...
def save = JavascriptReverseRoute(
   ...
   """
      function() {
      return _wA({method:"POST", url:"/models"})
      }
   """
)
...
def edit = JavascriptReverseRoute(
   ...
   """
      function(id) {
      return _wA({method:"GET", url:"/models/" + (""" + implicitly[PathBindable[Long]].javascriptUnbind + """)("id", id)})
      }
   """
)
